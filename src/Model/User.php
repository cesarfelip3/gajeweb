...
class User extends BaseModel
{
    ...
    public function getFollowerList($data)
    {
        ...
        $sql = "SELECT DISTINCT usr.*, fol.is_mutual AS is_mutual FROM {$this->table} usr INNER JOIN {$this->table_user_follow} fol ON usr.user_uuid=fol.user_followed_uuid ORDER BY fol.create_date DESC LIMIT {$limit}";
